...
do
    ...
    editcap -i 130 /media/mpec/eb38a860-81a7-43f8-9205-6df6e098435f/HUST_DATA/inCom_outGo_$i/outGoing$i.pcap /media/mpec/eb38a860-81a7-43f8-9205-6df6e098435f/HUST_DATA/inCom_outGo_$i/outGo/outGo$i
    ...
    do
        echo "Read $file"
        tshark -r /media/mpec/eb38a860-81a7-43f8-9205-6df6e098435f/HUST_DATA/inCom_outGo_$i/outGo/$file -T fields -e ip.src -e ip.dst -e tcp.srcport -e tcp.dstport -e udp.srcport -e udp.dstport -e frame.len -e ip.proto -e tcp.flags.syn -E header=y -E separator=, -E occurrence=f > /media/mpec/eb38a860-81a7-43f8-9205-6df6e098435f/file_$i/outGoNew/$file.csv
        echo "Done $file"
    done
    echo "Done file $i"
done
